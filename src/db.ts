...
export async function initDB(): Promise<duckdb.AsyncDuckDBConnection> {
    ...
    // Environment-specific URLs for datasets
    const episodesUrl = import.meta.env.PROD 
        ? 'https://raw.githubusercontent.com/tamanishi/check-ossanfm-feed/refs/heads/main/Episodes.parquet'
        : 'http://localhost:5173/static/episodes.parquet';

    const shownotesUrl = import.meta.env.PROD
        ? 'https://raw.githubusercontent.com/tamanishi/check-ossanfm-feed/refs/heads/main/Shownotes.parquet'
        : 'http://localhost:5173/static/shownotes.parquet';
